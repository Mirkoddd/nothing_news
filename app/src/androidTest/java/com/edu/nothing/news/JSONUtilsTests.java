...
import com.edu.nothing.news.local.JSONUtils;
...
public class JSONUtilsTests {
    ...
    public void loadLocalBanners_ShouldReturnContent_WhenFileExists() {
        ...
        Optional<String> result = JSONUtils.loadLocalJSON(context, fileName);
    ...
    public void loadLocalBanners_ShouldReturnEmpty_WhenFileNotFound() {
        ...
        Optional<String> result = JSONUtils.loadLocalJSON(context, fileNameThatDoesNotExists);
